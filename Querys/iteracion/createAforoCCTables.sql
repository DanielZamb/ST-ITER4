...
NOMBRE_CONTACTO VARCHAR2(255 BYTE),
...
CREATE TABLE A_AFORO_ACTUAL(
    ...
    TIPO_ESPACIO VARCHAR(20),
    AFORO_ACTUAL NUMBER NOT NULL,
    CONSTRAINT A_AFOROACTUAL_PK PRIMARY KEY (NUM_VISITANTES,TIPO_ESPACIO),
    ID_ESPACIO NUMBER
);
ALTER TABLE A_AFORO_ACTUAL
ADD CONSTRAINT CK_AFORO_ACTUAL
